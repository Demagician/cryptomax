        ...
        <div>
            <div id='about-header'>
              <div className='faq-title'>
                <span className='faq-f'>F</span><span className='faq-r'>r</span>
                <span className='faq-e'>e</span><span className='faq-q'>q</span>
                <span className='faq-u'>u</span><span className='faq-e2'>e</span>
                <span className='faq-n'>n</span><span className='faq-t'>t</span>
                <span className='faq-l'>l</span><span className='faq-y'>y</span> asked questions<span className='dot-1'>.</span>   
              </div>
            </div>
